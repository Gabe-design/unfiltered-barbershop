          ...
          <section>
            ...
            <div className="space-y-2">
              ...
              <div className="flex items-center justify-between px-4 py-2">
                ...
                <p className="text-indigo-400 font-bold">${booking.totalPrice.toFixed(2)}</p>
              </div>
            </div>
          </section>
            ...
            <section>
              ...
              <div className="bg-zinc-900/50 rounded-xl p-4">
                ...
                <a
                  ...
                  className="inline-flex items-center gap-1 text-indigo-400 text-xs mt-2 hover:underline"
                >
            ...
            <div className="relative flex-1 min-w-0">
              ...
              <input
                ...
                className="w-full bg-zinc-900 border border-zinc-700 text-white text-sm rounded-lg
                  pl-9 pr-4 py-2 focus:outline-none focus:border-indigo-500 placeholder:text-zinc-600 transition-colors"
              />
            </div>
            ...
            <div className="relative">
              ...
              <select
                ...
                className="bg-zinc-900 border border-zinc-700 text-white text-sm rounded-lg
                  pl-9 pr-8 py-2 focus:outline-none focus:border-indigo-500 transition-colors appearance-none"
              >
