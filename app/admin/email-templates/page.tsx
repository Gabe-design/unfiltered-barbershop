        ...
        <div className="fixed inset-0 bg-black/80 z-50 flex items-center justify-center p-4">
          <div className="bg-[#111111] border border-zinc-800 rounded-xl w-full max-w-3xl max-h-[90vh] overflow-y-auto flex flex-col">
            ...
            <div className="p-5 space-y-4 flex-1">
              ...
              <div>
                ...
                <textarea
                  ...
                  rows={14}
                  className="w-full bg-zinc-900 border border-zinc-700 rounded-lg px-3 py-2 text-white text-xs font-mono focus:outline-none focus:border-indigo-500 resize-y"
            ...
            <div className="flex gap-3 p-5 border-t border-zinc-800">
              ...
              <button onClick={save} disabled={saving} className="flex-1 py-2.5 rounded-lg text-sm font-medium bg-indigo-600 hover:bg-indigo-500 text-white disabled:opacity-50 transition-colors flex items-center justify-center gap-2">
