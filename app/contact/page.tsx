                ...
                <div className="bg-[#111111] border border-[#262626] rounded-3xl p-7 sm:p-9">
                  ...
                  {submitted ? (
                    ...
                    >
                      ...
                      <Link
                        href="/booking"
                        className="mt-2 inline-flex items-center gap-2 bg-blue-600 hover:bg-blue-500 text-white font-semibold px-6 py-3 rounded-xl transition-all duration-200"
                      >
                        Book Appointment
                    ...
                    <form onSubmit={handleSubmit} className="space-y-5">
                      ...
                      <div>
                        ...
                        <input
                          ...
                          className="w-full bg-white/5 border border-[#2a2a2a] hover:border-blue-500/30 focus:border-blue-500/60 focus:outline-none rounded-xl px-4 py-3.5 text-white placeholder-white/25 text-sm transition-colors"
                        />
                      </div>
                      ...
                      <div>
                        ...
                        <select
                          ...
                          value={form.service}
                          onChange={handleChange}
                          className="w-full bg-[#0f0f0f] border border-[#2a2a2a] hover:border-blue-500/30 focus:border-blue-500/60 focus:outline-none rounded-xl px-4 py-3.5 text-sm transition-colors appearance-none cursor-pointer"
                      ...
                      <div>
                        ...
                        <textarea
                          ...
                          className="w-full bg-white/5 border border-[#2a2a2a] hover:border-blue-500/30 focus:border-blue-500/60 focus:outline-none rounded-xl px-4 py-3.5 text-white placeholder-white/25 text-sm transition-colors resize-none"
                        />
                      </div>
                      ...
                      <button
                        type="submit"
                        disabled={submitting}
                        className="w-full flex items-center justify-center gap-2.5 bg-blue-600 hover:bg-blue-500 disabled:opacity-60 disabled:cursor-not-allowed text-white font-bold py-4 rounded-xl transition-all duration-200 hover:shadow-lg hover:shadow-blue-500/20 active:scale-[0.98]"
                      >
                        {submitting ? (
                          <>
          ...
          <div className="max-w-6xl mx-auto">
            ...
            >
              <iframe
                ...
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3293.4!2d-118.7815!3d34.2694!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x80e8234a4a4a4a4a%3A0x0!2s1706+Erringer+Rd+%234%2C+Simi+Valley%2C+CA+93065!5e0!3m2!1sen!2sus!4v1699999999999!5m2!1sen!2sus&style=feature:all|element:geometry|color:0x0a0a0a&style=feature:all|element:labels.text.stroke|color:0x0a0a0a&style=feature:all|element:labels.text.fill|color:0x666666"
                width="100%"
                height="100%"
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-5 mb-10">
              {testimonials.map((t, i) => (
                <motion.div
                  ...
                  className="bg-[#111111] border border-[#262626] hover:border-blue-500/25 rounded-2xl p-6 transition-all duration-300"
                >
            ...
            >
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center gap-2.5 bg-[#111111] hover:bg-[#161616] border border-[#262626] hover:border-blue-500/30 text-white font-semibold px-7 py-4 rounded-2xl transition-all duration-200 group"
              >
          ...
          <div className="max-w-3xl mx-auto">
            ...
            >
              ...
              <div className="relative">
                ...
                <Link
                  href="/booking"
                  className="inline-flex items-center gap-2 bg-blue-600 hover:bg-blue-500 text-white font-bold px-8 py-4 rounded-2xl transition-all duration-200 hover:shadow-xl hover:shadow-blue-500/25 active:scale-95"
                >
                  Book Appointment
                  <ArrowRight className="w-4 h-4" />
                </Link>
