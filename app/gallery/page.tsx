...
const galleryItems: GalleryItem[] = [
  {
    ...
    category: "Fades",
    gradient: "from-red-900/80 via-red-800/50 to-slate-900",
    tall: true,
  },
  {
    id: 2,
    ...
    category: "Beards",
    gradient: "from-slate-800/90 via-red-900/40 to-slate-900",
  },
  {
    id: 3,
    label: "Geometric Line Art",
    category: "Designs",
    gradient: "from-indigo-900/80 via-red-900/50 to-slate-900",
  },
  {
    id: 4,
    label: "Mid Fade - Textured Top",
    category: "Fades",
    gradient: "from-red-800/70 via-slate-800/60 to-slate-900",
  },
  {
    id: 5,
  ...
  },
  {
    ...
    category: "Beards",
    gradient: "from-red-900/60 via-red-900/50 to-slate-900",
  },
  {
    id: 7,
    label: "Creative Design - Spider",
    category: "Designs",
    gradient: "from-red-800/80 via-red-800/60 to-slate-900",
    tall: true,
  },
  {
    id: 8,
    ...
    category: "Fades",
    gradient: "from-red-700/60 via-red-900/50 to-slate-900",
  },
  {
    id: 9,
  ...
  },
  {
    ...
    category: "Fades",
    gradient: "from-red-800/80 via-red-700/40 to-slate-900",
  },
  {
    id: 11,
    label: "Logo Design - Custom Brand",
    category: "Designs",
    gradient: "from-red-900/90 via-red-800/60 to-slate-900",
    tall: true,
  },
  {
    id: 12,
    ...
    category: "Beards",
    gradient: "from-slate-800/80 via-red-900/50 to-slate-900",
  },
];
    ...
    >
      ...
      <div className="absolute top-4 right-4 w-1.5 h-12 rounded-full overflow-hidden opacity-30">
        <div
          ...
          style={{
            background:
              "repeating-linear-gradient(45deg, #DC2626 0px, #DC2626 4px, white 4px, white 8px, #ef4444 8px, #ef4444 12px, white 12px, white 16px)",
          }}
        />
      </div>
      ...
      <div className="absolute top-4 left-1/2 -translate-x-1/2">
        <span className="backdrop-blur-sm text-white text-[10px] font-bold tracking-[0.2em] uppercase px-3 py-1 rounded-full" style={{ background: "linear-gradient(135deg, #B91C1C 0%, #1D4ED8 100%)" }}>
          {item.category}
        </span>
      </div>
                ...
                <button
                  ...
                  className={cn(
                    ...
                    activeFilter === tab
                      ...
                      : "bg-[#111111] border border-[#262626] text-white/50 hover:text-white hover:border-red-500/30"
                  )}
                  style={activeFilter === tab ? { background: "linear-gradient(135deg, #B91C1C 0%, #1D4ED8 100%)" } : undefined}
                >
                  {tab}
                  {activeFilter === tab && (
        ...
        <section className="py-16 px-4 sm:px-6 border-t border-[#1a1a1a]">
          <div className="max-w-3xl mx-auto">
            <motion.div
              ...
              viewport={{ once: true }}
              transition={{ duration: 0.6 }}
              className="relative bg-gradient-to-br from-red-700/12 to-red-900/8 border border-red-500/20 rounded-3xl p-10 sm:p-14 text-center overflow-hidden"
            >
              <div className="absolute inset-0 pointer-events-none">
                <div className="absolute top-0 left-1/2 -translate-x-1/2 w-64 h-32 bg-red-600/12 rounded-full blur-3xl" />
              </div>
