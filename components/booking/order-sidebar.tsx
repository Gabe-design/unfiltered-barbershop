                    ...
                    >
                      <div className="flex items-center gap-2">
                        <button
                          ...
                          className="w-4 h-4 rounded-full bg-white/10 hover:[background:linear-gradient(135deg,#B91C1C33_0%,#1D4ED833_100%)] flex items-center justify-center transition-colors"
